  ...
  return (
    <div className="space-y-2.5">
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        <button
          onClick={() => {
            const cycle: Array<"claude" | "codex" | "goose" | "aider" | "openhands" | "openclaw" | "opencode"> = ["claude", "codex", "goose", "aider", "openhands", "openclaw", "opencode"];
            const idx = cycle.indexOf(form.backendType);
